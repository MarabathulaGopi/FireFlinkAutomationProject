...
public class WebDriverUtility {
	       ...
	       // maximize, minimize, full screen
			...
			public void explicitForElementToBeClickble(WebDriver driver, WebElement element)
			{
				WebDriverWait wait=new WebDriverWait(driver, Duration.ofSeconds(10));
	       ...
	       //handle the drop down -- list box
	        ...
	        // action class mouseOvering,drag and drop click and hold,
			...
			public void handleFrameByParentFrame(WebDriver driver)
			{
				driver.switchTo().parentFrame();
			}
			
			public void handleFrameByDefaultContent(WebDriver driver)
			{
			...
			public void handleAlertToDismiss(WebDriver driver)
			{
			...
			public void handleAlertToEnterText(WebDriver driver,String text)
			{
			...
			public void handleWindowToSwitchWindow(WebDriver driver)
			{
			...
			public void handleWindowToSwitchWindow(WebDriver driver,String title)
			{
